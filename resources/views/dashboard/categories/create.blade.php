                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating mb-3">
                            ...
                            <label for="slug_de">Slug Deutsche <span class="text-danger">*</span></label>
                            @error('slug_de')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-check form-switch">
                            <input type="checkbox" name="published" class="form-check-input" id="published" @checked(old('published'))>
