            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea id="content_fr" name="content_fr">{{old('content_fr')}}</textarea>
                        @error('content_fr')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-floating mb-3">
                            <input type="text" name="slug_de" class="form-control" id="slug_de" placeholder="Your Slug" value="{{old('slug_de')}}">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea id="content_de" name="content_de">{{old('content_de')}}</textarea>
                        @error('content_de')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 my-3">
                        <div class="form-check form-switch">
                            <input type="checkbox" name="is_published" class="form-check-input" id="is_published" value="1" @checked(old('is_published'))>
